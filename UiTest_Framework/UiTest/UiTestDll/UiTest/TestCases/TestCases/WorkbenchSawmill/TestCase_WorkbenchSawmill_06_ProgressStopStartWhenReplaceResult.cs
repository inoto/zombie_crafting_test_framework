...
{
	public class TestCase_WorkbenchSawmill_06_ProgressStopStartWhenReplaceResult : UiStepsTestCase
	{
		protected override IEnumerator<IUiTestStepBase> Condition()
		{
			...
			yield return new WorkbenchSawmill_ProgressStopStartWhenReplaceResultStep();
